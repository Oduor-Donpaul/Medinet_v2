...
urlpatterns = [
        path('', Home.as_view()),
        path('practitioners/', views.practitioner_view, name='practitioner-list'),
        path('practitioners/<int:pk>/', views.practitioner_detail_view, name='practitioner-detail'),
        ...
        path('services/<int:pk>/', views.service_detail_view, name='service-datails'),
